...
/*   Updated: 2025/12/14 13:37:11 by oelhasso         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	init_game_textures(t_game *game)
{
	...
	game->wtxt = NULL;
	game->etxt = NULL;
	game->txt_r_hand = NULL;
	game->txt_l_hand = NULL;
	game->txt_bomb = NULL;
	game->img_r_hand = NULL;
	game->img_l_hand = NULL;
	game->img_bomb = NULL;
}
...
void	free_textures(t_game *game)
{
	...
	if (game->txt_r_hand)
		mlx_delete_texture(game->txt_r_hand);
	if (game->txt_l_hand)
		mlx_delete_texture(game->txt_l_hand);
	if (game->txt_bomb)
		mlx_delete_texture(game->txt_bomb);
}
