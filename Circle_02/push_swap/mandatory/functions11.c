...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/01/24 21:05:55 by oelhasso          #+#    #+#             */
/*   Updated: 2025/01/25 11:23:16 by oelhasso         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	update_totals(t_stack *head)
{
	...
	while (tmp)
	{
		...
		{
			if (tmp->direction == 'u' && target->direction == 'd')
				return ;
			if (tmp->direction == 'd' && target->direction == 'u')
				return ;
