...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/01/24 21:05:45 by oelhasso          #+#    #+#             */
/*   Updated: 2025/01/31 22:07:56 by oelhasso         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	while (dgt(av[index.i][index.j]) || its_zaidnaqs(av[index.i][index.j]))
	{
		if (index.r == 0)
		{
		...
		index = handle_strflow (index, result, av);
	}
	return (index);
}
